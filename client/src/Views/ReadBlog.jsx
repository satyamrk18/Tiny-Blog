...
const ReadBlog = () => {
  ...
  <div className="min-h-screen bg-gray-100 py-10 px-4">
    ...
    <div className="max-w-6xl mt-15 mx-auto flex flex-col lg:flex-row gap-10">
      ...
      <div className="lg:w-3/4 bg-white shadow-xl p-8 rounded-2xl">
        ...
        <div className="prose max-w-none">
          <MDEditor.Markdown
            source={blog.content}
            style={{ whiteSpace: "pre-wrap", background: "white" }}
          />
        </div>
      </div>
      ...
      <div className="lg:w-1/4">
        <div className="bg-white shadow-xl rounded-2xl p-6 sticky top-10">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Author</h2>
